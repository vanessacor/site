...
function showOneImage (imageNumber) {
  const images = document.querySelectorAll('#hide-show-abstract img');
...
const buttons = document.querySelectorAll('#hide-show-abstract .button');
function handleButtonClick (event) {
  ...
  const index = clickedButton.getAttribute('image-number');
  showOneImage(index);
}
